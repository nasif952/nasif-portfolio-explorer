  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center pt-16 px-4 md:px-6 relative overflow-hidden bg-gradient-to-b from-background to-background/95">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute -top-20 -left-20 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-accent/30 to-primary/10 opacity-30 blur-3xl animate-float" style={{ animationDuration: '15s' }}></div>
        <div className="absolute top-1/4 right-0 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-primary/20 to-accent/20 opacity-30 blur-3xl animate-float" style={{ animationDuration: '20s', animationDelay: '2s' }}></div>
        <div className="absolute bottom-0 left-1/3 w-[700px] h-[700px] rounded-full bg-gradient-to-tr from-accent/25 to-primary/15 opacity-30 blur-3xl animate-float" style={{ animationDuration: '25s', animationDelay: '5s' }}></div>
        ...
        <div className="absolute top-1/3 left-1/4 w-20 h-20 bg-primary/10 rounded-full blur-md animate-pulse" style={{ animationDuration: '4s' }}></div>
        <div className="absolute bottom-1/4 right-1/3 w-16 h-16 bg-accent/15 rounded-full blur-md animate-pulse" style={{ animationDuration: '3s', animationDelay: '1s' }}></div>
